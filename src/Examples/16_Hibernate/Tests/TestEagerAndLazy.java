...
public class TestEagerAndLazy {
    ...
    public static void main(String[] args) {
        ...
        try (Session session = Util.getSessionFactory(List.of(
            ...
            DevelopmentTeam developmentTeam = new DevelopmentTeam("Yandex", 500_000, 70_000);

            Developer developer_1 = new Developer("dev1", "dev1", 110_000);
            Developer developer_2 = new Developer("dev2", "dev2", 300_300);
